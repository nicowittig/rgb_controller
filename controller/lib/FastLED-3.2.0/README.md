...
crgb_leds, this library also includes a number of functions for high-performing 8bit math for manipulating
...
* Quick start for new developers - hook up your crgb_leds and go, no need to think about specifics of the led chipsets being used
* Zero pain switching LED chipsets - you get some new crgb_leds that the library supports, just change the definition of LEDs you're using, et. voila!  Your code is running with the new crgb_leds.
...
How quickly can you get up and running with the library?  Here's a simple blink program:
	...
	void setup() { FastLED.addLeds<NEOPIXEL, 6>(crgb_leds, NUM_LEDS); }
	void loop() {
		crgb_leds[0] = CRGB::White; FastLED.show(); delay(30);
		crgb_leds[0] = CRGB::Black; FastLED.show(); delay(30);
	}
...
* Adafruit's Neopixel - aka the WS2812B (also WS2811/WS2812/WS2813, also supported in lo-speed cur_mode) - a 3 wire addressable led chipset
